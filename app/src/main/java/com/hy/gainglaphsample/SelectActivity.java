...
/**
 * Created by lim2621 on 2015-05-15.
 */
...
public class SelectActivity
    ...
    private void onRecord() {
        try {
            ...
            intent.setClassName("com.hy.myapplication", "com.hy.myapplicationdroid.RingdroidEditActivity");
    ...
    private void startRingdroidEditor() {
        ...
        try {
            ...
            intent.putExtra("was_get_content_intent", mWasGetContentIntent);
            intent.setClassName("com.hy.gainglaphsample", "com.hy.gainglaphsample.MainActivity");
            startActivityForResult(intent, REQUEST_CODE_EDIT);
            finish();
        } catch (Exception e) {
            Log.e("Ringdroid", "Couldn't start editor");
